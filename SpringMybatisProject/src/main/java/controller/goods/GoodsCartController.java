...
public class GoodsCartController {
	...
	public String reviewUpdate(@RequestParam(value="purchaseNum")String purchaseNum,
	...
	public String goodsCartQtyAdd(@RequestParam(value="cartQty")int cartQty,
								  @RequestParam(value="prodNum")String prodNum,
								  @RequestParam(value="prodPrice") int prodPrice,
								  Model model, HttpSession session) {
		goodsCartAddService.cartAdd(cartQty, prodNum, prodPrice, model, session);
		return "redirect:goodsCartList";
	}
