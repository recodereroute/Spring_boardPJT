...
$(function(){
	$("#cart").click(function(){
		...
		$.ajax({
			...
			dataType : "text",
			data : {"cartQty":cartQty,"prodNum":prodNum, "prodPrice":${goodsReviews.goods.prodPrice} },
...
<table>
	...
	<tr>					 		 <td>가격    :<fmt:formatNumber value = "${goodsReviews.goods.prodPrice }" type="currency"/> </td></tr>
	<tr>					 		 <td>배송비 :<fmt:formatNumber value = "${goodsReviews.goods.prodDelFee }" type="currency"/> </td></tr>
	<tr>					 		 <td>수량
	...
	<tr><td colspan="2">
	${goodsReviews.goods.prodDetail }<br />
	<p>
	<c:forTokens items="${goodsReviews.goods.prodImage }" delims="," var="image">
		<img src="../goods/upload/${image }" width="300"/><br />
	</c:forTokens>
	</p>
	</td></tr>
</table>
